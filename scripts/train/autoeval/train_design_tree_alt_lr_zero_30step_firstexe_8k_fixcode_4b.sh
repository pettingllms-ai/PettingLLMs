...
MODEL_PATH=${MODEL_PATH:-"Mercury7353/masrl_coldstart_4b"}
APPS_RATIO=${APPS_RATIO:-0.7}
EXPERIMENT_NAME=${EXPERIMENT_NAME:-"autoeval_mix_${DESIGN_SAMPLE_NUM}d_${EXECUTE_SAMPLE_NUM}e_mix_question_grouping_altlr_zerolr_30steps_firstexe_7k_fixcode_4b"}
