...
# ============================================
MODEL_PATHS=(
    "/home/lah003/workspace/verl_efficient/checkpoints/default_experiment/global_step_41/actor/checkpoint"
)

# Assuming execution from repository root
REPO_ROOT="$(pwd)"
CONFIG_PATH="${REPO_ROOT}/pettingllms/config/pychecker_rl"
CONFIG_NAME="pychecker_rl_L2_multi_agent"
BENCHMARK="pychecker"
MAX_TURNS=1
...
echo
echo "======================================"
echo "Multi-agent evaluation completed successfully!"
echo "======================================"
