...
HOST="127.0.0.1"
GPU_MEM=0.8
TP_SIZE=4  # Tensor parallel size (number of GPUs per model)
           # IMPORTANT: Must be divisible by model's attention heads
           # Qwen3-8B has 32 heads, so use: 1, 2, 4, 8, 16, or 32
