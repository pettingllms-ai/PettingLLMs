...
class SampleToolAgent(Agent):
    ...
    async def step(self, env_data: Env, env_worker: Any = None):
        ...
        try:
            ...
            env_data.state.code_generated_solution_list.append(env_data.state.code_generated_solution)
            env_data.state.code_extracted_answer_list.append(env_data.state.code_extracted_answer)
