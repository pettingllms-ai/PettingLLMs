...
from pettingllms.verl.async_server import AsyncLLMServerManager
...
def compute_advantage(data: DataProto, adv_estimator, gamma=1.0, lam=1.0, num_repeat=1, norm_adv_by_std_in_grpo=True, mask_truncated_samples=False, clip_advantages=False, **kwargs):
...
class RayPPOTrainer:
    ...
    def _save_checkpoint(self):
        ...
        local_latest_checkpointed_iteration = os.path.join(experiment_folder, "latest_checkpointed_iteration.txt")
