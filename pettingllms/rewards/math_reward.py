...
def pettingllms_reward_fn_math(data_source: str, llm_solution: str, ground_truth: str | list[str], extra_info=None, **kwargs):
    ...
    Example:
        >>> pettingllms_reward_fn_math("gsm8k", "x = 5", "5", False)
        True
    """
